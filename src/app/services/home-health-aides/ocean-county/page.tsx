...
import { oceanCountyHomeHealthAidesContent } from '@/lib/content/ocean-county-home-health-aides'

// Export metadata directly from content
export const metadata = oceanCountyHomeHealthAidesContent.metadata

export default function HomeHealthAidesOceanCountyPage() {
    const content = oceanCountyHomeHealthAidesContent
            ...
            <main className="bg-white">
                ...
                <section id="service-areas" className="py-16 px-4 bg-gray-50">
                    <div className="container mx-auto max-w-6xl">
                        <h2 className="text-3xl lg:text-4xl font-bold text-primary mb-12 text-center font-merriweather">
                            Our Home Health Aide Service Areas in Ocean County
                        </h2>
                ...
                {content.servicesBenefits && (
                    <CountyBenefitsSection
                        title="Benefits of Ocean County CHHAs"
