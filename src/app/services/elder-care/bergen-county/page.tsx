...
// TODO: Add cross-links to other Bergen County service hub pages:
// - /services/personal-care/bergen-county (already created)
// - /services/companion-care/bergen-county (already created)
...
export const metadata = bergenCountyElderCareContent.metadata

export default function ElderCareBergenCountyPage() {
    const content = bergenCountyElderCareContent
    const citySlugs = getCitySlugs('elder-care', 'bergen-county')
                ...
                <section id="service-areas" className="py-16 px-4 bg-gray-50">
                    <div className="container mx-auto max-w-6xl">
                        <h2 className="text-3xl lg:text-4xl font-bold text-primary mb-12 text-center font-merriweather">
                            Elder Care Consulting by Region
                        </h2>
