...
import { oceanCountyElderCareContent } from '@/lib/content/ocean-county-elder-care'

export const metadata = oceanCountyElderCareContent.metadata

export default function ElderCareOceanCountyPage() {
    const content = oceanCountyElderCareContent
