...
import ElderCareSeoHead from '@/lib/seo/elderCare'
                ...
                <div className="bg-white-bright py-8">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-gray-700 max-w-3xl">
                            Leverage our experience and expertise to evaluate
                            your parent or loved one's situation. We can help
                            you explore all options available to your
                            family—from aging in place to placement in an
                            assisted living facility or a nursing home. We can
                            also help you steward the available options and
                            refer you to competent elder care attorneys and
                            accountants.
                        </p>
                    </AnimatedSection>
                </div>
                ...
                >
                    ...
                    <div className="bg-secondary rounded-lg shadow-lg p-8 mb-8">
                        <p className="text-lg text-white">
                            Navigating elder care options can be overwhelming.
                            At{' '}
                        ...
                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                            <div className="bg-white p-6 rounded-lg shadow-md">
                                ...
                                <p className="text-gray-700">
                                    ...
                                    loved one's needs, preferences, and current
                                    living situation.
                                </p>
                            </div>
                            <div className="bg-white p-6 rounded-lg shadow-md">
                                ...
                                <p className="text-gray-700">
                                    Explore all available care options—from
                                    aging in place to assisted living facilities
                                    or nursing homes.
                                </p>
                            </div>
                            <div className="bg-white p-6 rounded-lg shadow-md">
                                ...
                                <p className="text-gray-700">
                                    Create a personalized care plan that
                                    respects your loved one's wishes and meets
                                    their unique needs.
                                </p>
                            </div>
                            <div className="bg-white p-6 rounded-lg shadow-md">
                                ...
                                <p className="text-gray-700">
                                    Connect you with trusted elder care
                                    attorneys and accountants for legal and
                                    financial guidance.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 my-auto">
                            ...
                            <div className="bg-secondary rounded-lg my-auto">
                                <p className="text-lg text-white mb-6">
                                    ...
                                    understand the complexities of elder care.
                                ...
                                <ul className="space-y-4">
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <span className="text-white">
                                            Expertise in assessing care needs
                                            and matching them with appropriate
                                            services
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span className="text-white">
                                            ...
                                            prioritizes dignity and quality of
                                            life
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                ...
                <div className="bg-gray-50 py-16">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-700 mb-12 text-center max-w-3xl mx-auto">
                            ...
                            conversation about your loved one's situation and
                            your family's concerns. We'll then:
                        </p>
                        <div className="flex flex-col space-y-6 mb-12">
                            <div className="flex items-center bg-white p-6 rounded-lg shadow-md">
                                ...
                                <p className="text-gray-700">
                                    Evaluate your loved one's physical,
                            ...
                            <div className="flex items-center bg-white p-6 rounded-lg shadow-md">
                                ...
                                <p className="text-gray-700">
                                    Review your financial resources and
                                    insurance coverage
                                </p>
                            </div>
                            <div className="flex items-center bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="container px-4 py-16 max-w-6xl">
                    ...
                    >
                        ...
                        <p className="text-lg mb-8 max-w-3xl mx-auto">
                            ...
                            approach to care. We're committed to addressing
                            every aspect of your loved one's well-being and
                            supporting your family through important care
                            decisions.
                        </p>
                        <CallToAction
