...
import { oceanCountyStaffingContent } from '@/lib/content/ocean-county-staffing'

// Export metadata directly from content
export const metadata = oceanCountyStaffingContent.metadata

export default function StaffingOceanCountyPage() {
    const content = oceanCountyStaffingContent
            ...
            <main className="bg-white">
                ...
                <section id="service-areas" className="py-16 px-4 bg-gray-50">
                    <div className="container mx-auto max-w-6xl">
                        <h2 className="text-3xl lg:text-4xl font-bold text-primary mb-12 text-center font-merriweather">
                            Our Healthcare Staffing Service Areas in Ocean
                            County
                        </h2>
                ...
                {content.servicesBenefits && (
                    <CountyBenefitsSection
                        title="Benefits of Ocean County Healthcare Staffing"
