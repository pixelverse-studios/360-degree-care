...
import PersonalCareSeoHead from '@/lib/seo/personalCare'
            ...
            <main className="breadcrumbSpacing">
                ...
                >
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        services designed to assist individuals with Daily
                        Living Activities (ADLs) and promote overall well-being.
                        Whether you're seeking solutions for yourself or a loved
                        one, <CompanyName className="" /> is here to guide you.
                    </p>
                    <h2 className="mt-6 mb-2">What is Personal Care?</h2>
                    <p className="text-gray-700 mb-4">
                        Personal care, also known as personal care services,
                        refers to non-medical assistance that helps individuals
                        maintain independence and improve their quality of life
                        at home, including elderly personal care.
                    </p>
                    ...
                    <ul className="mb-4 flex flex-col gap-2">
                        <li className="bullet-item">
                            ...
                            <p>
                                ...
                                <br />A personal care aide empowers individuals
                                to remain independent in their homes for longer.
                            </p>
                        </li>
                        <li className="bullet-item">
                            <CircleCheck className="text-primary" />
                            <p>
                                ...
                                <br />
                                Assistance with daily tasks allows individuals
                                to focus on activities they enjoy.
                            </p>
                        </li>
                        <li className="bullet-item">
                            <CircleCheck className="text-primary" />
                    ...
                    <ul className="mb-4 flex flex-col gap-2">
                        ...
                        <li className="bullet-item">
                            ...
                            <p>
                                ...
                                <br />
                                Planning, shopping, and preparing nutritious
                                meals.
                            </p>
                        </li>
                        <li className="bullet-item">
                        ...
                        <li className="bullet-item">
                            ...
                            <p>
                                ...
                                <br />
                                Helping with appointments and community
                                activities.
                            </p>
                        </li>
                    </ul>
                    ...
                    <p className="text-gray-700 mb-4">
                        ...
                        range of personal care services to create a customized
                        care plan that promotes independence, dignity, and
                        well-being.
                    </p>
                </AnimatedSection>
            </main>
