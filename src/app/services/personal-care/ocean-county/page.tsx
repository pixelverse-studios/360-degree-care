...
import { oceanCountyPersonalCareContent } from '@/lib/content/ocean-county-personal-care'

export const metadata = oceanCountyPersonalCareContent.metadata

export default function PersonalCareOceanCountyPage() {
    const content = oceanCountyPersonalCareContent
