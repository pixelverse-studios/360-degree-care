...
import SkilledNursingSeoHead from '@/lib/seo/nursing'

export default function NursingServicesPage() {
    return (
        <>
            <SkilledNursingSeoHead />
                ...
                <div className="bg-white-bright">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-gray-700 max-w-3xl">
                            ...
                            From physical assessments to wound care and
                            medication management, our licensed professionals
                            ensure the highest standard of healthcare in the
                    ...
                    >
                        ...
                        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
                            <p className="text-lg text-gray-700 mb-6">
                                ...
                                provides expert care with the same compassion
                                and attention to detail that has made us the
                                leading home care company in New Jersey for over
                                ten years.
                            </p>
                        </div>
                    </AnimatedSection>
                                ...
                                <div className="md:flex">
                                    ...
                                    <div className="md:w-2/3 p-8">
                                        <h3 className="text-2xl font-semibold mb-4">
                                            Physical Assessments and Plan of
                                            Care
                                        </h3>
                                        <p className="text-gray-700 mb-4">
                                            Our skilled nurses conduct thorough
                                            physical assessments to evaluate
                                            your current health status, identify
                                        ...
                                        <ul className="space-y-2">
                                            ...
                                            <li className="bullet-item items-center">
                                                <CircleCheck className="text-primary h-6 w-6" />
                                                <span className="text-gray-700">
                                                    Regular reassessments to
                                                    ensure care plans remain
                                ...
                                <div className="md:flex flex-row-reverse">
                                    ...
                                    <div className="md:w-2/3 p-8">
                                        ...
                                        <p className="text-gray-700 mb-4">
                                            ...
                                            complications. We provide
                                            professional treatment for various
                                            wound types, including surgical
                                            wounds, pressure injuries, diabetic
                                            ulcers, and more.
                                        </p>
                                        <ul className="space-y-2">
                                            <li className="bullet-item items-center">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-12">
                            <div className="rounded-lg p-6 text-center bg-white shadow-xl">
                                ...
                                <p className="text-gray-700">
                                    ...
                                    home healthcare and specialized training in
                                    geriatric care.
                                </p>
                            </div>
                            <div className="rounded-lg p-6 text-center bg-white shadow-xl">
                                ...
                                <p className="text-gray-700">
                                    ...
                                    to ensure coordinated care that meets all
                                    your health needs.
                                </p>
                            </div>
                            <div className="rounded-lg p-6 text-center bg-white shadow-xl">
                                ...
                                <p className="text-gray-700">
                                    Our nursing services are available around
                                    the clock, ensuring you have access to care
                                    whenever you need it, including evenings,
                ...
                <div className="container mx-auto px-4 py-16 max-w-custom">
                    ...
                    >
                        ...
                        <p className="text-lg mb-8 max-w-3xl mx-auto">
                            ...
                            learn more about how our nursing team can support
