...
import { oceanCountyNursingContent } from '@/lib/content/ocean-county-nursing'

export const metadata = oceanCountyNursingContent.metadata

export default function NursingOceanCountyPage() {
    const content = oceanCountyNursingContent
