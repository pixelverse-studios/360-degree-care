...
import { oceanCountyCompanionCareContent } from '@/lib/content/ocean-county-companion-care'

export const metadata = oceanCountyCompanionCareContent.metadata

export default function CompanionCareOceanCountyPage() {
    const content = oceanCountyCompanionCareContent
