...
export const bergenCountyPersonalCareContent: ServiceCountyPageContent = {
    ...
    intro: {
        ...
        content: [
            ...
            'Families consistently tell us the approach works. Dina R. of Ridgewood wrote in December 2024 that “the whole team feels like family” after we supported her mom with a live-in aide and 24/7 nurse access; Carmine L. in Fair Lawn echoed that sentiment in February 2025 when he called our help a “total game changer.” Every testimonial is a reminder that Bergen County families value reliable, hyper-local caregivers they can reach any hour of the day.'
        ]
    },
    ...
    regionalSections: [
        ...
        },
        {
            ...
            content: [
                "As the county seat and heart of Bergen County, Hackensack serves as a central hub for medical care, government services, and urban conveniences that benefit seniors throughout the region. Our <a href='/services/personal-care/bergen-county/hackensack'>personal care services in Hackensack</a> leverage the city's exceptional resources, including the renowned Hackensack University Medical Center, one of New Jersey's largest and most comprehensive healthcare facilities.",
        ...
        },
        {
            ...
            content: [
                ...
                'Our <a href="/services/personal-care/bergen-county/ridgewood">Ridgewood personal care services</a> extend to families throughout the Pascack Valley and surrounding areas. Ridgewood, with its picturesque downtown, excellent medical facilities at Valley Hospital, and strong sense of community, represents the best of suburban Bergen County living. The nearby communities of Fair Lawn, Glen Rock, Midland Park, and Waldwick share similar qualities—established neighborhoods, excellent services, and a commitment to supporting aging residents.',
                "Valley Hospital in Ridgewood serves as a primary medical resource for the region, and our caregivers are well-versed in navigating its campus and coordinating with its extensive network of physicians and specialists. The hospital's senior services, including the Center for Healthy Aging, complement our in-home care to provide comprehensive support. When Valley Health officially opened its new Paramus campus in April 2024, we immediately updated transportation plans and caregiver orientations so every client bound for the state-of-the-art facility arrived with a familiar advocate by their side.",
