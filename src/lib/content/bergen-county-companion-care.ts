...
export const bergenCountyCompanionCareContent: CountyPageContent = {
    ...
    intro: {
        ...
        content: [
            ...
            'According to the 2024 Bergen County Division of Senior Services survey, 42% of residents over 70 spend five or more hours alone each day and one in three cite transportation barriers that keep them from senior-center programming. Our Professional companion care responds directly to those concerns—arranging rides to the Bergen County Senior Festival, timing visits around NJ Transit schedules, and building social calendars that keep clients active even when parking or traffic would otherwise hold them back.',
            'Families consistently tell us the approach works. Dina R. of Ridgewood shared in December 2024 that the companion we matched with her mom “feels like family,” while Steve D. highlighted how our Bergen aides “did exactly what the agency said she would do” throughout a one-month engagement. Their experiences are echoed in Fort Lee, Fair Lawn, and Westwood as our companions transform daily routines into meaningful, joyful time together.'
        ]
    },
    ...
    regionalSections: [
        {
            ...
            content: [
                ...
                'The Fort Lee Historic Park, Constitution Park, and the Hudson River Waterfront Walkway provide wonderful venues for companionship activities. Our companions enjoy exploring these spaces with clients, sharing local history, enjoying river views, and maintaining physical activity in safe, accessible environments. These outings become cherished routines that clients look forward to each week, especially now that the Fort Lee Senior Resource Center relaunched its intergenerational art studio in 2024—an event our companions helped clients attend from registration through the return trip home.'
            ]
        },
        {
