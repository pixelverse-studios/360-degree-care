...
export const bergenCountyNursingContent: ServiceCountyPageContent = {
    ...
    intro: {
        ...
        content: [
            ...
            'The 2024 Bergen County Community Health Improvement Plan highlighted a 6% uptick in preventable hospital readmissions driven by medication errors and unmanaged wounds. Our nursing protocols were rebuilt around those findings: two-step medication verification, wound-photo documentation shared with physicians, and discharge coordination meetings with HUMC, Valley Hospital, and Holy Name before patients return home.',
            'Families notice the difference. Debbie V. praised how we staffed an overnight hospital companion within hours on a weekend before shifting to skilled nursing, while Amanda S. highlighted our Tuesday nurse calls that keep aides, clients, and families aligned. Their experiences underscore why Bergen County clinicians rely on our RNs and LPNs between office visits.'
        ]
    },
