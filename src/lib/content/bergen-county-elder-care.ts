...
export const bergenCountyElderCareContent: CountyPageContent = {
    ...
    intro: {
        ...
        content: [
            ...
            'Bergen County’s 2024 Age-Friendly Action Plan reported that 41% of family caregivers feel “somewhat or very overwhelmed,” while 37% don’t know whom to call when a crisis strikes outside business hours. Our consultants respond with 24/7 availability, step-by-step contingency plans, and proactive introductions to county-backed respite, transportation, and meals programs so families never face emergencies alone.',
            'Recent families have seen the difference firsthand. JoAnn C. shared how we secured a live-in aide within 36 hours after her father’s discharge, and Amanda S. highlighted the weekly nurse check-ins that keep everyone aligned. Those experiences mirror what consulting clients across Fort Lee, Hackensack, and Ridgewood experience when they lean on us for planning and advocacy.'
        ]
    },
