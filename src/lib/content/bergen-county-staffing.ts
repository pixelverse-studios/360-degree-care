...
export const bergenCountyStaffingContent: ServiceCountyPageContent = {
    ...
    intro: {
        ...
        content: [
            ...
            'According to the 2024 Bergen County Workforce Development snapshot, 62% of local healthcare facilities reported critical staffing gaps tied to seasonal surges, and 48% cited burnout-related turnover. Our Bergen-based per-diem pool, on-call nurse managers, and rapid orientation system respond directly to those pressures so inpatient units, urgent cares, and senior communities maintain census without compromising safety.',
            'Administrators consistently validate the approach. A Hackensack clinical director praised our ability to deploy bilingual CNAs during flu season, while a Ridgewood practice manager shared that our temporary RN “felt like part of the team from day one” thanks to pre-shift briefings. Their feedback mirrors the experience of facilities across Fort Lee, Paramus, and Englewood that rely on us for stable coverage.'
        ]
    },
