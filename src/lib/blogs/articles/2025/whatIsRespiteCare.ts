...
const whatIsRespiteCare = {
    ...
    content: `You've been caring for your aging parent for months—maybe years. You manage their medications, drive them to appointments, prepare meals, help with bathing, and handle a dozen other tasks. You do it out of love, but you're exhausted.
...
**Care delivery:** While you're away, the caregiver provides whatever support your loved one needs—[personal care](/services/personal-care), [companionship](/services/companion-care), meals, medication reminders, light housekeeping.
...
Even if you need to pay out of pocket, respite care doesn't have to be extensive. Even a few hours weekly can make a meaningful difference. For more on costs, see our guide on [home care costs in Northern New Jersey](/blog/cost-of-home-care-northern-new-jersey).
...
In-home respite care costs are similar to regular home care rates—hourly fees that vary based on location and level of care needed. See our guide on [home care costs in Northern New Jersey](/blog/cost-of-home-care-northern-new-jersey) or [contact us](/contact/services) for specific pricing based on your situation.

**How often should I use respite care?**
There's no single answer. Some caregivers benefit from a few hours weekly; others need longer but less frequent breaks. Listen to your body and emotions. If you're depleted, you need more breaks than you're taking.

**Will my loved one be upset when I leave?**
There may be initial adjustment, especially for those with dementia. But most older adults settle in once the caregiver arrives and they become engaged in conversation or activities. And you can always call to check in.
