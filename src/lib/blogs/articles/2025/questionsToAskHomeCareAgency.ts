...
const questionsToAskHomeCareAgency = {
    ...
    seo: {
        ...
        keywords: [
            ...
            'hiring home care agency',
            'home care interview questions',
            'Bergen County home care',
            'caregiver screening',
            'home care checklist NJ'
        ]
    },
    contentType: 'markdown',
    content: `Hiring a home care agency is one of the most important decisions you'll make for an aging parent or loved one. The right agency becomes an extension of your family. The wrong choice can lead to stress, turnover, and inadequate care.
...
**What to listen for:** An initial in-home assessment, a written care plan developed with family input, and regular reviews to adjust as needs change. Ask who conducts the assessment and what their qualifications are. [Learn about our approach to care](/about).
