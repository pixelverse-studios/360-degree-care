...
const northJerseyCaregiverRoadmap = {
    id: 'north-jersey-caregiver-roadmap',
    title: 'North Jersey Caregiver Roadmap: Managing Chronic Conditions at Home Without Losing Your Sanity',
    slug: 'north-jersey-caregiver-roadmap',
    excerpt:
    ...
    tags: [
        'North Jersey caregiver roadmap',
        'chronic condition home care NJ',
        'COPD care Bergen County',
        'heart failure home health aide NJ',
        'Parkinsons support at home',
        'diabetes care North Jersey'
    ],
    seo: {
        metaDescription:
            "Use this North Jersey caregiver roadmap to coordinate COPD, CHF, diabetes, and Parkinson's support with home health aides, nurses, and specialists while protecting your own sanity.",
        keywords: [
            'North Jersey caregiver guide',
            'chronic disease home care NJ',
            'COPD home health aide Bergen County',
            'CHF home care plan New Jersey',
            'Parkinsons care at home NJ',
            'caregiver burnout prevention NJ'
        ]
    },
    contentType: 'markdown',
    content: `# North Jersey Caregiver Roadmap: Managing Chronic Conditions at Home Without Losing Your Sanity
...
![Care coordinator reviewing a chronic-condition plan with a family caregiver](nurse_care)
*A structured roadmap keeps complex care safe and sane*
...
Need help? Our [Bergen County personal care team](/services/personal-care/bergen-county) and [Passaic County nursing services](/services/nursing/passaic-county) can walk the home with you.
...
- **Respite rotation** – Schedule relatives or [companion care in Monmouth County](/services/companion-care/monmouth-county) for at least one 4-hour block per week.
...
export default northJerseyCaregiverRoadmap
