...
const lateLifeCrisis = {
    ...
    excerpt:
        'For adult children of aging parents, finding quality in-home care in New Jersey can be overwhelming. Discover how professional services offer peace of mind and maintain dignity.',
